...
<html lang="en">
<head>
  <title>APLIKASI KASIR TOKO ADE</title>
  <meta charset="utf-8">
...
<div class="container">
  <a class="navbar-brand px-3 bg-warning">TOKO BERKAH</a>
  ...
  <div class="collapse navbar-collapse" id="navbarC">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="laporan_produk.php">
        <span class="text-center d-block pt-2"><i class="fa fa-chart-bar fa-2x"></i></span>laporan Produk</a>
      </li>
      <li class="nav-item">
