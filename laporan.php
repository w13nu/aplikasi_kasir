...
<div class="card-header">
    <div class="card-title">
        <form method="GET" class="row g-2">
            ...
            <div class="col-md-9">
                <!-- Tombol untuk memilih bulan -->
                <button type="button" class="btn btn-light" onclick="showMonth(1)">Januari</button>
                <button type="button" class="btn btn-light" onclick="showMonth(2)">Februari</button>
                <button type="button" class="btn btn-light" onclick="showMonth(3)">Maret</button>
                <button type="button" class="btn btn-light" onclick="showMonth(4)">April</button>
                <button type="button" class="btn btn-light" onclick="showMonth(5)">Mei</button>
                <button type="button" class="btn btn-light" onclick="showMonth(6)">Juni</button>
                <button type="button" class="btn btn-light" onclick="showMonth(7)">Juli</button>
                <button type="button" class="btn btn-light" onclick="showMonth(8)">Agustus</button>
                <button type="button" class="btn btn-light" onclick="showMonth(9)">September</button>
                <button type="button" class="btn btn-light" onclick="showMonth(10)">Oktober</button>
                <button type="button" class="btn btn-light" onclick="showMonth(11)">November</button>
                <button type="button" class="btn btn-light" onclick="showMonth(12)">Desember</button>
            </div>
        </form>

        <script>
            // Fungsi untuk mengarahkan ke laporan berdasarkan bulan yang diklik
            function showMonth(month) {
                let year = document.querySelector('[name="tahun"]').value; // Ambil nilai tahun yang dipilih
                if (year) {
                    window.location.href = `laporan.php?bulan=${month}&tahun=${year}`;
                } else {
    ...
    <div class="card-body">
        ...
        <table class="table table-striped table-sm table-bordered dt-responsive nowrap" id="table" width="100%">
            ...
            <tr>
                ...
                <td>
                    <?php 
                    $itungtrans = mysqli_query($conn,"SELECT SUM(quantity) as jumlahtrans FROM tb_nota WHERE no_nota='$nota'");
